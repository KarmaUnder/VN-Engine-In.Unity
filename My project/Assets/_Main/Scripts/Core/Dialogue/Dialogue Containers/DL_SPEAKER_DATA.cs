...
namespace DIALOGUE
{
    ...
    public class DL_SPEAKER_DATA
    {
        ...
        public List<(int layer, string expression)> CastExpresions { get; set; }
        ...
        public DL_SPEAKER_DATA(string rawSpeaker)
        {
            ...
            CastExpresions = new List<(int layer, string expression)>();
            ...
            for (int i = 0; i < matches.Count; i++)
            {
                ...
                else if (match.Value == EXPRESSIONCAST_ID)
                {
                    ...
                    CastExpresions = castExp.Split(EXPRESSIONLAYER_JOINER)
                    .Select(x =>
                    {
