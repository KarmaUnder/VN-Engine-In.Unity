...
namespace CHARACTERS
{
    public class Character_Manager : MonoBehaviour
    {
        ...
        public void SortCharacters(string[] characterNames)
        {
            ...
            List<Character> remainedCharacters = characters.Values
            ...
            int startingPriority = remainedCharacters.Count > 0 ? remainedCharacters.Max(c => c.priority) : 0;
            ...
            List<Character> allCharacters = remainedCharacters.Concat(sortedCharacters).ToList();
